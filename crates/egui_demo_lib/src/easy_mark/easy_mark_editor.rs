...
[The reference parser](https://github.com/emilk/egui/blob/master/crates/egui_demo_lib/test/easy_mark/easy_mark_parser.rs) is \~250 lines of code, using only the Rust standard library. The parser uses no look-ahead or recursion.
